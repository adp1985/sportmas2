const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://sportmas2.pythonanywhere.com/clientes", // Retorna todos los registro de la tabla productos
        clientes:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://sportmas2.pythonanywhere.com/clientes/' + id
            var options = {
                method: 'DELETE',
